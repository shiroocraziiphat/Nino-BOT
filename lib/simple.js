 ...
 */
    ...
    */
    ...
    reply(jid, text, quoted, options) {
      return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : this.sendMessage(jid, text, MessageType.extendedText, { contextInfo: { mentionedJid: this.parseMention(text), externalAdReply: {title: 'Nino BOT', body: 'Nino BOT', sourceUrl: '', thumbnail: fs.readFileSync('./nino1.jpg')}}, sendEphemeral: true, quoted, ...options })
    }
